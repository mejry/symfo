...
class ClasseController extends AbstractController
{
    ...
    #[Route('/add_classe', name: 'app_classe_new', methods: ['GET', 'POST'])]
    ...
    public function edit(Request $request, Classe $classe, $id,EntityManagerInterface $entityManager): Response
    {
        $classe==$entityManager->getRepository("App\Entity\Classe")->find($id);
        $form = $this->createForm(ClasseType::class, $classe);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Classe $classe,$id, EntityManagerInterface $entityManager): Response
    {
        $classe==$entityManager->getRepository("App\Entity\Classe")->find($id);
